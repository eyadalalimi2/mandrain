            ...
            <div class="col-md-8 offset-md-2">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">إضافة وحدة قياس جديدة</h3>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control @error('code') is-invalid @enderror" id="code"
                                            ...
                                            <option value="KG" {{ old('code') == 'KG' ? 'selected' : '' }}>KG</option>
                                            <option value="HALF" {{ old('code') == 'HALF' ? 'selected' : '' }}>HALF
                                            </option>
                                            <option value="QUARTER" {{ old('code') == 'QUARTER' ? 'selected' : '' }}>QUARTER
                                            </option>
                                            <option value="BASKET" {{ old('code') == 'BASKET' ? 'selected' : '' }}>BASKET
                                            </option>
                                        </select>
                                        @error('code')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" step="0.01"
                                            ...
                                            name="factor" value="{{ old('factor') }}" min="0">
                                        @error('factor')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
